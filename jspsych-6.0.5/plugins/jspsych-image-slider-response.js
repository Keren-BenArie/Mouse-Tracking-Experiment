...
jsPsych.plugins['image-slider-response'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    html += '<div class="jspsych-image-slider-response-container" style="position:relative; width:500px;">';
    html += '<input type="range" value="'+trial.start+'" min="'+trial.min+'" max="'+trial.max+'" step="'+trial.step+'" style="width: 85%;" id="jspsych-image-slider-response-response"></input>';
    html += '<div>'
